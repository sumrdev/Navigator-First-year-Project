...
public class MapColor {
    ...
    private MapColor() {
        ...
        deuteranopiaBlindColorMap.put("WATER_close", Color.rgb(176, 211, 232, 1));
        ...
        protanopiaBlindColorMap.put("MOTORWAY_close", Color.YELLOW);
        protanopiaBlindColorMap.put("MOTORWAY_OUTLINE", Color.ORANGE);
        protanopiaBlindColorMap.put("MOTORWAY_OUTLINE_close", Color.ORANGE);
        ...
        protanopiaBlindColorMap.put("PRIMARY_close", Color.LIGHTYELLOW);
        protanopiaBlindColorMap.put("PRIMARY_OUTLINE", Color.YELLOW);
        protanopiaBlindColorMap.put("PRIMARY_OUTLINE_close", Color.YELLOW);
