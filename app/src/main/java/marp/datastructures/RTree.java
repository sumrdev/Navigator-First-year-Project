...
public class RTree<T extends Element> implements Serializable {
    ...
    protected class Node implements Serializable {
        ...
        boolean hasChildren;
        int layer;
        // [0],[1] will be min, coords, (x,y respectively) and [2],[3] will be max
        // coords
        float[] boundingRect;
        // values kan laves til en linked list da denne er samme hastighed at lave for
        // each på
            ...
            values.sort(new Comparator<T>() {
                ...
                public int compare(T o1, T o2) {
                    return (o1.getBounds()[layer % dimensions] < o2.getBounds()[layer % dimensions]) ? -1
                            : (o1.getBounds()[layer % dimensions] > o2.getBounds()[layer % dimensions]) ? 1 : 0;
                }
            });
        }
        ...
        protected boolean intersects(float[] rangeCoords) {
            ...
            // return boundingRect[0] <= rangeCoords[2] && rangeCoords[0] <= boundingRect[2]
            // && boundingRect[1] <= rangeCoords[3] && rangeCoords[1] <= boundingRect[3];
        }
        ...
        // could maybe add the coords as values int the node to not get them from the
        // value everytime
    }
    ...
    public class NodeDistance implements Comparable<NodeDistance> {
        ...
        public int compareTo(NodeDistance o2) {
            return (this.distance < o2.distance) ? -1 : (this.distance > o2.distance) ? 1 : 0;
        }
    }
