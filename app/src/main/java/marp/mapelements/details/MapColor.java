...
public class MapColor {
    ...
    private MapColor() {
        ...
        darkColorMap.put("GRASS", Color.rgb(117, 151, 126,1));
        ...
        darkColorMap.put("PATH", Color.web("#003400"));
        ...
        deuteranopiaBlindColorMap.put("GRASS", Color.web("#CEC4D6"));
        ...
        deuteranopiaBlindColorMap.put("PATH", Color.PURPLE);
        ...
        monochromaBlindColorMap.put("GRASS", Color.web("#C1C1C1"));
